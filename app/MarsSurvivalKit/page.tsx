    ...
    <div className="min-h-screen bg-gradient-to-bl from-[#697bee] via-black to-[#ee8869] text-white font-sans p-8 md:p-12">
      <div className="max-w-7xl mx-auto">
        ...
        <header className="mb-12 flex items-center justify-between">
          <h1 className="text-4xl font-bold">Mars Survival Kit</h1>
        ...
        <p className="text-gray-300 -mt-8 mb-8">Tips and guidance for surviving on Mars.</p>
        ...
        <main className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-3xl font-semibold mb-4">How to survive on mars</h2>
